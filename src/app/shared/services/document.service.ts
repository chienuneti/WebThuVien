...
export class DocumentService {
  ...
  getAllowedCollections(): Observable<any[]> {
  return this.http.get<any[]>(`${this.apiUrl}/allowed-collections`);
}
  ...
  getAdvancedDocuments(params: any): Observable<PaginatedResult<DocumentListDto>> {
  return this.http.get<PaginatedResult<DocumentListDto>>(`${this.apiUrl}/advanced`, { params });
}
  ...
  getDisciplines(): Observable<Discipline[]>{
    return this.http.get<any[]>(`${environment.apiUrl}/Documents/getAllDisciplines`);
  }

  getFaculties(): Observable<Discipline[]>{
    return this.http.get<any[]>(`${environment.apiUrl}/Documents/getAllFaculties`);
  }
}